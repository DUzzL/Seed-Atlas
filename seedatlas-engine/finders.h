 ...
 * The engine does not provide exact overworld surface height and cannot
...
/* Extended variant of getBiomeCenters(). The status output is set to zero
 * when the range was completely examined, one when the output capacity was
 * reached, and -1 when temporary storage could not be allocated.
 */
int getBiomeCentersEx(
        Pos           * pos,
        int           * siz,
        int             nmax,
        Generator     * g,
